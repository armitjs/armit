  ...
  overrides: [
    {
      ...
      rules: {
        ...
        // @theme, @docusaurus, etc aren't actual paths. They are webpack aliases.
        // To prevent ESLint from tripping up on those, you could ignore those in the ESLint settings
