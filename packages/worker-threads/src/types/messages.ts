...
export function isThreadCallbackMessage(
  msg: BaseThreadMessage
): msg is ThreadCallbackMessage {
  return msg.action === ThreadMessageAction.RESOLVE;
}

export function isThreadErrorMessage(
  msg: BaseThreadMessage
): msg is ThreadErrorMessage {
  return msg.action === ThreadMessageAction.REJECT;
}

export function isThreadFunctionMessage(
  msg: BaseThreadMessage
): msg is ThreadFunctionMessage {
  return msg.action === ThreadMessageAction.CALL_FUNCTION;
}

export function isThreadFreeFunctionMessage(
  msg: BaseThreadMessage
): msg is ThreadFreeFunctionMessage {
  return msg.action === ThreadMessageAction.FREE_FUNCTION;
}

export function isThreadReadyMessage(
  msg: BaseThreadMessage
): msg is ThreadReadyMessage {
  return msg.action === ThreadMessageAction.READY;
}

export function isThreadStartupErrorMessage(
  msg: BaseThreadMessage
): msg is ThreadErrorMessage {
