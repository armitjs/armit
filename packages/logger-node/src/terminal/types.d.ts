 ...
 */
export type Color = Exclude<keyof typeof picocolors, 'createColors' | 'isColorSupported'>;
/**
 ...
 */
export interface TerminalConstructorData<L extends string> extends CustomizedStdWriteStream {
    /**
