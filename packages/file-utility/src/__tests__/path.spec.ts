import { isJunkFile, isNotJunkFile } from '../file-junk.js';
import { ensureSlash, isPathMatch, normalizeSlash } from '../file-path.js';
...
describe('isPathMatch', () => {
  ...
  it('convert backwards-slash paths to forward slash paths', () => {
    expect(normalizeSlash('c:/aaaa\\bbbb')).toBe('c:/aaaa/bbbb');
    expect(normalizeSlash('c:\\aaaa\\bbbb')).toBe('c:/aaaa/bbbb');
    expect(normalizeSlash('c:\\aaaa\\bbbb\\★')).toBe('c:/aaaa/bbbb/★');
  });
